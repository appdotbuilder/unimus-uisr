...
class StoreDatasetRequest extends FormRequest
{
    ...
    {
        return auth()->check() && in_array(auth()->user()->role, ['contributor', 'curator', 'admin']);
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'dataset_file' => 'required|file|mimes:csv,json|max:51200', // 50MB
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'dataset_file.required' => 'Dataset file is required.',
